	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-10">
				...
				<form:form modelAttribute="may"
					action="${pageContext.request.contextPath}/updatemay" method="post">
					<form:input path="maMay" type="hidden" id="idmay"
						class="form-control" />
					<div class="form-group">
						<label for=""> Vi Tri<span>(*)</span></label>
						<form:input path="viTri" type="text" id="" class="form-control" />
					</div>
					<div class="form-group">
					...
					<div class="foot">
						<div class="back">
							<button type="button" class="btn btn-info deletemay">
